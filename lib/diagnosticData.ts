...
export const DIAGNOSTIC_QUESTIONS: DiagQuestion[] = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    correct: 3,
    explanation: "Layers: ⌊220 ÷ 40⌋ = 5. Best floor layout — 36 cm across 264 cm: ⌊264 ÷ 36⌋ = 7; 54 cm along 342 cm: ⌊342 ÷ 54⌋ = 6. Per layer: 7 × 6 = 42. Total: 42 × 5 = 210.",
  },
  {
    ...
    correct: 1,
    explanation: "82% of 210 = 172.2. You cannot exceed 82% full, so round down: 172. Loading 173 would be 82.4% — over the limit.",
  },
  {
    ...
    options: ["61%", "65%", "68%", "72%"],
    correct: 1,
    explanation: "Module mass: 172 × 86 = 14,792 kg. Spacecraft: 7.84 t = 7,840 kg. Total: 22,632 kg. Module share = 14,792 ÷ 22,632 × 100 ≈ 65%.",
  },
  {
    ...
    correct: 0,
    explanation: "New module mass: 86 × 1.12 = 96.32 kg. Space rule: 210 × 90% = 189 modules allowed. Mass cap: 15,000 ÷ 96.32 ≈ 155.7 → floor to 155 (156 modules = 15,026 kg, over the cap). The mass cap is the tighter limit → 155.",
  },
