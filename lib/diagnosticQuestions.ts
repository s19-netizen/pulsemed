...
export const DIAGNOSTIC_QUESTIONS: DiagnosticQuestion[] = [
  ...
  // ── QR ──────────────────────────────────────────────────────────────────
  // Dataset: Orbital cargo loading (Space Geometry)
  {
    id: "qr-1",
    section: "qr",
    subtype: "qr-data-tables",
    subtypeLabel: "3D Geometry",
    passage: "A resupply spacecraft carries rectangular Life-Support Modules (LSMs) to an orbital station. The cargo bay external internal-wall dimensions are 2.88 m wide × 3.60 m long × 2.40 m high. Shielding reduces usable dimensions: 12 cm on both side walls, 9 cm on both end walls, 15 cm on the floor, 5 cm on the ceiling. Each LSM is 54 cm × 36 cm footprint, 40 cm tall and must remain upright. LSMs may be rotated 90° on the floor but cannot be stacked on their sides.",
    question: "What is the maximum number of LSMs that can fit inside the shielded cargo bay?",
    options: ["180", "195", "200", "210"],
    correct: 3,
    explanation: "Usable: width = 288 − 24 = 264 cm; length = 360 − 18 = 342 cm; height = 240 − 20 = 220 cm. Layers: 220 ÷ 40 = 5 (ignore 0.5). Best orientation — 36 cm across 264 cm: 264 ÷ 36 = 7; 54 cm along 342 cm: 342 ÷ 54 = 6. Per layer: 7 × 6 = 42. Total: 42 × 5 = 210.",
  },
  {
    id: "qr-2",
    section: "qr",
    subtype: "qr-percentages",
    subtypeLabel: "Percentages & Rounding",
    passage: "Using the maximum capacity of 210 LSM positions from the previous question, the station requires 18% of all positions to remain empty to allow emergency access.",
    question: "What is the greatest number of LSMs that may actually be loaded?",
    options: ["171", "172", "173", "174"],
    correct: 1,
    explanation: "82% of 210 = 172.2. You cannot load a fraction of a module, and you must not exceed 82%, so round down: 172. (173 would occupy 82.38% — over the limit.)",
  },
  {
    id: "qr-3",
    section: "qr",
    subtype: "qr-units",
    subtypeLabel: "Mass & Percentages",
    passage: "Each LSM has a mass of 86 kg. The spacecraft's own mass before loading is 7.84 tonnes. 172 LSMs are loaded.",
    question: "What percentage of the spacecraft's final mass is due to the LSMs? (Nearest whole %)",
    options: ["61%", "65%", "68%", "72%"],
    correct: 1,
    explanation: "LSM mass: 172 × 86 = 14,792 kg. Spacecraft: 7.84 t = 7,840 kg. Final mass: 14,792 + 7,840 = 22,632 kg. LSM % = 14,792 ÷ 22,632 × 100 ≈ 65.4% → 65%.",
  },
  {
    id: "qr-4",
    section: "qr",
    subtype: "qr-algebra",
    subtypeLabel: "Multi-constraint Optimisation",
    passage: "Engineers propose a redesigned LSM with the same external dimensions (so 210 positions still fit), 12% greater mass than the original 86 kg, and the emergency-access requirement drops from 18% empty to 10% empty. The total cargo-module mass limit is 15.0 tonnes.",
    question: "What is the maximum number of redesigned LSMs that can be loaded without exceeding either the space or the 15.0-tonne mass limit?",
    options: ["155", "156", "175", "189"],
    correct: 0,
    explanation: "New mass: 86 × 1.12 = 96.32 kg. Space limit: 210 × 0.90 = 189 modules. Mass limit: 15,000 ÷ 96.32 ≈ 155.73 → floor to 155 (156 × 96.32 = 15,026 kg, over limit). Binding constraint = mass → 155.",
  },
  {
    id: "qr-5",
    section: "qr",
